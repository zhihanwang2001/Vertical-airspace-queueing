...
\begin{itemize}
    ...
    \item \textbf{HCA2C-Wide}: Same hierarchical architecture but moderately wider action space [0.4,1.6]×[0.8,3.5] without capacity constraints (821K parameters)
...
\input{tables/tab_ablation_simple}
