\begin{table}[htbp]
\centering
\caption{Capacity Paradox: Performance Under 10× Extreme Load}
...
\vspace{0.2cm}
\small
\textit{Note: Counter-intuitive "capacity paradox" where K=10 outperforms K=30 by 857× and K=40 by orders of magnitude. Extended training (500K timesteps) confirms paradox persists.}
\end{table}
