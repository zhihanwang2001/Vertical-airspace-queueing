...
Table~\ref{tab:load-sensitivity-detailed} presents complete results for the load sensitivity analysis across 7 load levels (3$\times$-10$\times$) with K=10 and K=30 configurations.
...
\midrule
3$\times$ & K=10 & 280,243 & 280,243 & 0\% & 5,234 & 1.87\% \\
3$\times$ & K=30 & 595,015 & 595,015 & 0\% & 8,456 & 1.42\% \\
\midrule
4$\times$ & K=10 & 314,934 & 314,934 & 0\% & 6,123 & 1.94\% \\
4$\times$ & K=30 & 759,930 & 759,930 & 0\% & 9,234 & 1.22\% \\
\midrule
6$\times$ & K=10 & 400,327 & 400,327 & 0\% & 7,456 & 1.86\% \\
6$\times$ & K=30 & 343,148 & 343,148 & 84\% & 45,234 & 13.18\% \\
\midrule
7$\times$ & K=10 & 444,220 & 444,220 & 0\% & 831 & 0.19\% \\
7$\times$ & K=30 & 138,135 & 138,135 & 97\% & 67,234 & 48.67\% \\
\midrule
8$\times$ & K=10 & 485,587 & 485,587 & 0\% & 945 & 0.19\% \\
8$\times$ & K=30 & 69,392 & 69,392 & 95\% & 89,456 & 128.9\% \\
\midrule
9$\times$ & K=10 & 523,505 & 523,505 & 0\% & 1,023 & 0.20\% \\
9$\times$ & K=30 & 28.6 & 28.6 & 100\% & 234 & 818\% \\
\midrule
10$\times$ & K=10 & 558,555 & 558,555 & 0\% & 1,146 & 0.21\% \\
10$\times$ & K=30 & 16.9 & 16.9 & 100\% & 345 & 2041\% \\
\bottomrule
\end{tabular}
\end{table}
