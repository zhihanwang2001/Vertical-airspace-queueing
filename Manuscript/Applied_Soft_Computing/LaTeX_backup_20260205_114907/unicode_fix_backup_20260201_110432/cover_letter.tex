...
\item \textbf{Capacity Paradox Discovery:} We discover and validate a counter-intuitive capacity paradox where low-capacity systems (K=10) outperform high-capacity systems (K=30+) by orders of magnitude under extreme load conditions ($\geq$8× baseline), challenging conventional capacity planning assumptions.
